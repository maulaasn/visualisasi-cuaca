<nav class="bg-white border-b border-slate-300 sticky top-0 z-[3000]">
    <div class="flex px-5 md:px-10 h-[70px]">
        ...
        <div class="hidden [&.show]:flex md:flex absolute top-[70px] left-0 right-0 bg-white md:bg-transparent flex-col h-auto shadow-md md:static md:flex-row md:h-full md:shadow-none md:-mb-[1px]" id="navMenu">
            <a href="{{ route('map.index') }}" class="flex items-center gap-2 px-5 py-4 md:py-0 font-medium text-[14px] md:text-[15px] md:h-full transition-colors duration-200 border-l-[3px] md:border-l-0 md:border-b-[3px] {{ request()->routeIs('map.index') ? 'text-blue-600 border-blue-600' : 'text-slate-500 border-transparent hover:text-blue-600' }}">
            ...
            <a href="{{ route('warning.index') }}" class="flex items-center gap-2 px-5 py-4 md:py-0 font-medium text-[14px] md:text-[15px] md:h-full transition-colors duration-200 border-l-[3px] md:border-l-0 md:border-b-[3px] {{ request()->routeIs('warning.*') ? 'text-blue-600 border-blue-600' : 'text-slate-500 border-transparent hover:text-blue-600' }}">
            ...
            <a href="{{ route('news.index') }}" class="flex items-center gap-2 px-5 py-4 md:py-0 font-medium text-[14px] md:text-[15px] md:h-full transition-colors duration-200 border-l-[3px] md:border-l-0 md:border-b-[3px] {{ request()->routeIs('news.index') || request()->routeIs('news.show') ? 'text-blue-600 border-blue-600' : 'text-slate-500 border-transparent hover:text-blue-600' }}">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
