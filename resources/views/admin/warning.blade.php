    ...
    <div class="warning-card bg-orange-50 border border-orange-200 rounded-lg overflow-hidden w-full h-auto flex flex-col">
        <div class="warning-card-header p-4 md:p-6 flex flex-col md:flex-row justify-between md:items-start gap-4 md:gap-8">     
            <div class="warning-title-wrapper flex gap-4 items-start flex-1">
                ...
                @if($iconType === 'petir')
                <svg class="shrink-0 w-6 h-7 md:w-8 md:h-8 mt-1 md:mt-1.5" viewBox="0 0 24 24" fill="none" stroke="#ea580c" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <a href="{{ route('admin.warning.detail') }}" class="bg-transparent hover:text-orange-700 text-orange-600 font-bold text-[13px] md:text-sm py-2 transition-colors whitespace-nowrap text-left md:text-right self-start md:self-auto no-underline">
