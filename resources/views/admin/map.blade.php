...
@section('content')
    <div class="map-container flex-1 p-3 md:p-[30px] relative h-full">
        ...
        <div class="absolute top-[40px] md:top-[45px] right-[24px] md:right-[42px] z-[1500] flex flex-col items-end">
            ...
            <div id="layer-popup" class="hidden mb-3 bg-white rounded-lg shadow-[0_4px_20px_rgba(0,0,0,0.15)] p-3 flex gap-2 transition-all duration-300 border border-slate-100">
                ...
                <button id="btn-cuaca" class="flex flex-col items-center gap-1.5 transition focus:outline-none group">
                    <div id="icon-cuaca" class="w-[52px] h-[52px] rounded-lg border-2 border-[#1a73e8] transition-all relative overflow-hidden flex items-center justify-center text-[#1a73e8] shadow-sm bg-white">
                ...
                <button id="btn-suhu" class="flex flex-col items-center gap-1.5 transition focus:outline-none group">
                    <div id="icon-suhu" class="w-[52px] h-[52px] rounded-lg border-2 border-transparent transition-all relative overflow-hidden flex items-center justify-center text-slate-500 shadow-sm bg-slate-50 group-hover:bg-white">
        ...
        <div id="filter-cuaca" class="filter-box absolute bottom-[24px] md:bottom-[45px] left-[24px] md:left-[42px] bg-white/95 p-2.5 md:p-[15px] rounded-lg shadow-[0_4px_15px_rgba(0,0,0,0.1)] z-[1000] min-w-[130px] md:min-w-[160px] scale-[0.85] md:scale-100 origin-bottom-left border border-slate-100">
            <div class="filter-header text-xs md:text-[12px] font-bold text-slate-800 mb-2 md:mb-2.5 pb-1 md:pb-2 border-b border-slate-200">Filter Cuaca</div>
            <div class="filter-list flex flex-col gap-2">
                <label class="filter-item flex items-center gap-2 text-[11px] text-slate-700 cursor-pointer select-none"><input type="checkbox" class="filter-checkbox-cuaca accent-blue-600 w-3.5 h-3.5 cursor-pointer m-0" value="Cerah" checked> <span>Cerah</span></label>
                <label class="filter-item flex items-center gap-2 text-[11px] text-slate-700 cursor-pointer select-none"><input type="checkbox" class="filter-checkbox-cuaca accent-blue-600 w-3.5 h-3.5 cursor-pointer m-0" value="Cerah Berawan" checked> <span>Cerah Berawan</span></label>
                <label class="filter-item flex items-center gap-2 text-[11px] text-slate-700 cursor-pointer select-none"><input type="checkbox" class="filter-checkbox-cuaca accent-blue-600 w-3.5 h-3.5 cursor-pointer m-0" value="Berawan" checked> <span>Berawan</span></label>
                <label class="filter-item flex items-center gap-2 text-[11px] text-slate-700 cursor-pointer select-none"><input type="checkbox" class="filter-checkbox-cuaca accent-blue-600 w-3.5 h-3.5 cursor-pointer m-0" value="Berawan Tebal" checked> <span>Berawan Tebal</span></label>
                <label class="filter-item flex items-center gap-2 text-[11px] text-slate-700 cursor-pointer select-none"><input type="checkbox" class="filter-checkbox-cuaca accent-blue-600 w-3.5 h-3.5 cursor-pointer m-0" value="Udara Kabur" checked> <span>Udara Kabur</span></label>
                <label class="filter-item flex items-center gap-2 text-[11px] text-slate-700 cursor-pointer select-none"><input type="checkbox" class="filter-checkbox-cuaca accent-blue-600 w-3.5 h-3.5 cursor-pointer m-0" value="Kabut/Asap" checked> <span>Kabut/Asap</span></label>
                <label class="filter-item flex items-center gap-2 text-[11px] text-slate-700 cursor-pointer select-none"><input type="checkbox" class="filter-checkbox-cuaca accent-blue-600 w-3.5 h-3.5 cursor-pointer m-0" value="Hujan Ringan" checked> <span>Hujan Ringan</span></label>
                <label class="filter-item flex items-center gap-2 text-[11px] text-slate-700 cursor-pointer select-none"><input type="checkbox" class="filter-checkbox-cuaca accent-blue-600 w-3.5 h-3.5 cursor-pointer m-0" value="Hujan Sedang" checked> <span>Hujan Sedang</span></label>
                <label class="filter-item flex items-center gap-2 text-[11px] text-slate-700 cursor-pointer select-none"><input type="checkbox" class="filter-checkbox-cuaca accent-blue-600 w-3.5 h-3.5 cursor-pointer m-0" value="Hujan Lebat" checked> <span>Hujan Lebat</span></label>
                <label class="filter-item flex items-center gap-2 text-[11px] text-slate-700 cursor-pointer select-none"><input type="checkbox" class="filter-checkbox-cuaca accent-blue-600 w-3.5 h-3.5 cursor-pointer m-0" value="Hujan Petir" checked> <span>Hujan Petir</span></label>
                <label class="filter-item flex items-center gap-2 text-[11px] text-slate-700 cursor-pointer select-none"><input type="checkbox" class="filter-checkbox-cuaca accent-blue-600 w-3.5 h-3.5 cursor-pointer m-0" value="Hujan Petir Hebat" checked> <span>Hujan Petir Hebat</span></label>
            </div>
        </div>

        <div id="filter-suhu" class="filter-box hidden absolute bottom-[24px] md:bottom-[45px] left-[24px] md:left-[42px] bg-white/95 p-2.5 md:p-[15px] rounded-lg shadow-[0_4px_15px_rgba(0,0,0,0.1)] z-[1000] min-w-[130px] md:min-w-[160px] scale-[0.85] md:scale-100 origin-bottom-left border border-slate-100">
            <div class="filter-header text-xs md:text-[12px] font-bold text-slate-800 mb-2 md:mb-2.5 pb-1 md:pb-2 border-b border-slate-200">Filter Suhu</div>
            <div class="filter-list flex flex-col gap-2 max-h-[140px] md:max-h-[250px] overflow-y-auto">
                <label class="flex items-center gap-2 text-[11px] text-slate-700 cursor-pointer"><input type="checkbox" class="filter-checkbox-suhu accent-blue-600 w-3.5 h-3.5 m-0" value="Sangat Panas" checked> <span>Sangat Panas</span></label>
                <label class="flex items-center gap-2 text-[11px] text-slate-700 cursor-pointer"><input type="checkbox" class="filter-checkbox-suhu accent-blue-600 w-3.5 h-3.5 m-0" value="Panas" checked> <span>Panas</span></label>
                <label class="flex items-center gap-2 text-[11px] text-slate-700 cursor-pointer"><input type="checkbox" class="filter-checkbox-suhu accent-blue-600 w-3.5 h-3.5 m-0" value="Normal" checked> <span>Normal</span></label>
                <label class="flex items-center gap-2 text-[11px] text-slate-700 cursor-pointer"><input type="checkbox" class="filter-checkbox-suhu accent-blue-600 w-3.5 h-3.5 m-0" value="Sejuk" checked> <span>Sejuk</span></label>
                <label class="flex items-center gap-2 text-[11px] text-slate-700 cursor-pointer"><input type="checkbox" class="filter-checkbox-suhu accent-blue-600 w-3.5 h-3.5 m-0" value="Dingin" checked> <span>Dingin</span></label>
            </div>
        </div>

        <div id="legend-cuaca" class="legend-box absolute bottom-[44px] md:bottom-[58px] right-[24px] md:right-[42px] bg-white/95 p-[15px_20px] rounded-lg shadow-[0_4px_15px_rgba(0,0,0,0.1)] z-[1000] text-[11px] text-slate-700 pointer-events-none scale-[0.75] md:scale-100 origin-bottom-right border border-slate-100">
        ...
        <div id="legend-suhu" class="legend-box hidden absolute bottom-[44px] md:bottom-[58px] right-[24px] md:right-[42px] bg-white/95 p-[15px_20px] rounded-lg shadow-[0_4px_15px_rgba(0,0,0,0.1)] z-[1000] text-[11px] text-slate-700 pointer-events-none scale-[0.75] md:scale-100 origin-bottom-right border border-slate-100">
