    ...
    <div class="warning-map-container p-5 md:p-[30px_40px] m-0 w-full box-border">
        ...
        <div class="mb-4 flex flex-col md:flex-row md:items-center justify-between gap-3 md:gap-0">
            <a href="{{ route('warning.index') }}"
                class="order-1 md:order-2 text-[13px] md:text-sm text-orange-600 hover:text-orange-600 font-medium transition-colors no-underline inline-flex items-center gap-1.5 self-start">
                <span class="inline-flex items-center justify-center -translate-y-[1px] md:translate-y-0 text-lg md:text-base leading-none">
                    &larr;
                </span>
        ...
        <div
            class="bg-orange-50 border border-orange-200 rounded-lg p-3 md:p-6 w-full flex flex-col h-[65vh] md:h-[70vh] min-h-[400px] md:min-h-[500px]">

            <div id="full-map" class="w-full flex-grow rounded-lg border border-orange-200 z-10 bg-gray-100"></div>

            <div
                class="warning-footer mt-3 md:mt-4 pt-3 md:pt-4 border-t border-dashed border-orange-200 text-center text-right text-[10px] md:text-xs text-slate-400">
