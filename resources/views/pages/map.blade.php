...
@section('content')
    <div class="map-container flex-1 p-4 md:p-[30px_40px] relative h-[calc(100vh-70px)]">
        ...
        <div class="filter-box absolute bottom-[40px] md:bottom-[45px] left-7 md:left-[52px] bg-white/95 p-2.5 md:p-[15px] rounded-lg shadow-[0_4px_15px_rgba(0,0,0,0.1)] z-[1000] min-w-[130px] md:min-w-[160px] scale-[0.85] md:scale-100 origin-bottom-left">
        ...
        <div class="legend-box absolute bottom-[44px] md:bottom-[58px] right-[26px] md:right-[52px] bg-white/95 p-[15px_20px] rounded-lg shadow-[0_4px_15px_rgba(0,0,0,0.1)] z-[1000] text-xs text-slate-700 pointer-events-none scale-[0.75] md:scale-100 origin-bottom-right">
