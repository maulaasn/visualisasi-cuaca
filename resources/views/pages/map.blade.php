...
@section('content')
    <div class="map-container flex-1 p-4 md:p-[30px_40px] relative h-[calc(100vh-70px)]">
        <div id="loading-screen" class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-[2000] flex justify-center items-center bg-white/95 px-5 py-3 rounded-full shadow-lg border border-slate-100 transition-opacity duration-500">
            <svg class="animate-spin text-blue-600 w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none"
                viewBox="0 0 24 24">
        ...
        <div class="absolute top-[40px] md:top-[45px] right-[26px] md:right-[52px] z-[1500] flex flex-col items-end">
        ...
        <div id="filter-cuaca" class="filter-box hidden absolute bottom-[40px] md:bottom-[45px] left-7 md:left-[52px] bg-white/95 p-2.5 md:p-[15px] rounded-lg shadow-[0_4px_15px_rgba(0,0,0,0.1)] z-[1000] min-w-[130px] md:min-w-[160px] scale-[0.85] md:scale-100 origin-bottom-left">
            ...
            <div class="filter-list flex flex-col gap-2 max-h-[140px] md:max-h-none md:overflow-visible overflow-y-auto">
        ...
        <div id="filter-suhu" class="filter-box absolute bottom-[40px] md:bottom-[45px] left-7 md:left-[52px] bg-white/95 p-2.5 md:p-[15px] rounded-lg shadow-[0_4px_15px_rgba(0,0,0,0.1)] z-[1000] min-w-[130px] md:min-w-[160px] scale-[0.85] md:scale-100 origin-bottom-left">
        ...
        <div id="legend-cuaca" class="legend-box hidden absolute bottom-[44px] md:bottom-[58px] right-[26px] md:right-[52px] bg-white/95 p-[15px_20px] rounded-lg shadow-[0_4px_15px_rgba(0,0,0,0.1)] z-[1000] text-xs text-slate-700 pointer-events-none scale-[0.75] md:scale-100 origin-bottom-right">
        ...
        <div id="legend-suhu" class="legend-box absolute bottom-[44px] md:bottom-[58px] right-[26px] md:right-[52px] bg-white/95 p-[15px_20px] rounded-lg shadow-[0_4px_15px_rgba(0,0,0,0.1)] z-[1000] text-xs text-slate-700 pointer-events-none scale-[0.75] md:scale-100 origin-bottom-right">
