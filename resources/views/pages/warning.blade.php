...
<div class="warning-container p-5 md:p-[30px_40px] m-0 w-full box-border">
    <div class="warning-header mb-4 md:mb-6">
        <h1 class="page-title text-[15px] md:text-[20px] font-bold text-slate-800 m-0 mb-1 md:mb-1.5">Informasi Peringatan Dini</h1>
        ...
        <div class="warning-card-header p-4 md:p-6 flex flex-col md:flex-row justify-between md:items-start gap-3 md:gap-8">     
            <div class="warning-title-wrapper flex gap-3 md:gap-4 items-start flex-1">
                ...
                <div class="warning-title-text w-full md:pr-6">
                    ...
                    <h2 class="text-sm md:text-base font-bold text-slate-800 m-0 mb-2 md:mb-3">{{ $warning['title'] }}</h2>
                    <p class="warning-summary text-justify pr-3 md:pr-0 text-[12px] md:text-sm text-slate-600 m-0 mb-3 md:mb-5 leading-relaxed">
                        {{ $warning['description'] }}
                    </p>
